...
**原图标废止，感谢设计师[Mārtiņš Zemlickis](http://mzemlickis.lv/)的出色设计，新的图标将在几天后发布。**
...
代码采用Mozilla Public License 2.0协议授权。请查阅[LICENSE](https://github.com/elliottzheng/CopyTranslator/blob/master/LICENSE) 文件，获取更多信息。
